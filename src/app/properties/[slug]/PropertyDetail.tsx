...
export default function PropertyDetail({ property, allProperties }: { property: Property | null; allProperties: Property[] }) {
  ...
  const similar = allProperties.filter((p) => p.slug !== property.slug).slice(0, 3);
